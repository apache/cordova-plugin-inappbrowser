...
#define    kInAppBrowserAlignLeft @"left"
#define    kInAppBrowserAlignRight @"right"

#define    kInAppBrowserPropEvent @"event"
#define    kInAppBrowserPropLabel @"label"
#define    kInAppBrowserPropColor @"color"
#define    kInAppBrowserPropHeight @"height"
#define    kInAppBrowserPropImage @"image"
#define    kInAppBrowserPropWwwImage @"wwwImage"
#define    kInAppBrowserPropImagePressed @"imagePressed"
#define    kInAppBrowserPropWwwImagePressed @"wwwImagePressed"
#define    kInAppBrowserPropWwwImageDensity @"wwwImageDensity"
#define    kInAppBrowserPropStaticText @"staticText"
#define    kInAppBrowserPropShowPageTitle @"showPageTitle"
#define    kInAppBrowserPropAlign @"align"
#define    kInAppBrowserPropTitle @"title"
#define    kInAppBrowserPropCancel @"cancel"
#define    kInAppBrowserPropItems @"items"

#define    kInAppBrowserEmitError @"InAppBrowserError"
#define    kInAppBrowserEmitWarning @"InAppBrowserWarning"
#define    kInAppBrowserEmitCodeCritical @"critical"
#define    kInAppBrowserEmitCodeLoadFail @"loadfail"
#define    kInAppBrowserEmitCodeUnexpected @"unexpected"
#define    kInAppBrowserEmitCodeUndefined @"undefined"
...
@interface CDVInAppBrowser () {
    ...
    NSURL *initUrl;  // initial URL InAppBrowser opened with
    NSURL *originalUrl;
}
@end
...
- (void)reload:(CDVInvokedUrlCommand*)command
{
    if (self.inAppBrowserViewController) {
        [self.inAppBrowserViewController reload];
    }
}
...
- (CDVInAppBrowserOptions*)parseOptions:(NSString*)options
{
    ...
    if (options && [options length] > 0) {
        ...
        if(error) {
            [self emitError:kInAppBrowserEmitCodeCritical
        ...
        [self emitWarning:kInAppBrowserEmitCodeUndefined
...
{
    CDVInAppBrowserOptions* browserOptions = [self parseOptions:options];
    ...
    if (self.inAppBrowserViewController == nil) {
        ...
        self.inAppBrowserViewController = [[CDVInAppBrowserViewController alloc]
    ...
    [self.inAppBrowserViewController showToolBar:YES:browserOptions.toolbarposition];
...
- (void)openInCordovaWebView:(NSURL*)url withOptions:(NSString*)options
{
    ...
    } else { // this assumes the openInInAppBrowser can be excepted from the white-list
...
- (void)createViews
{
    ...
    CGFloat toolbarHeight = [self getFloatFromDict:toolbarProps withKey:kInAppBrowserPropHeight withDefault:TOOLBAR_HEIGHT];
    ...
    self.toolbar.backgroundColor = [CDVInAppBrowserViewController colorFromRGBA:[self getStringFromDict:toolbarProps withKey:kInAppBrowserPropColor withDefault:@"#ffffffff"]];
    
    if (toolbarProps[kInAppBrowserPropImage] || toolbarProps[kInAppBrowserPropWwwImage]) {
        UIImage *image = [self getImage:toolbarProps[kInAppBrowserPropImage]
                                altPath:toolbarProps[kInAppBrowserPropWwwImage]
                             altDensity:[toolbarProps[kInAppBrowserPropWwwImageDensity] doubleValue]];
        
        if (image) {
            self.toolbar.backgroundColor = [UIColor colorWithPatternImage:image];
        } else {
            [self.navigationDelegate emitError:kInAppBrowserEmitCodeLoadFail
                                   withMessage:[NSString stringWithFormat:@"Image for toolbar, %@, failed to load.",
                                                toolbarProps[kInAppBrowserPropImage]
                                                ? toolbarProps[kInAppBrowserPropImage] : toolbarProps[kInAppBrowserPropWwwImage]]];
        }
    }
    ...
    if (self.closeButton) {
        ...
        if ([kInAppBrowserAlignRight isEqualToString:_browserOptions.closeButton[kInAppBrowserPropAlign]]) {
    ...
    if (self.menuButton) {
        ...
        if ([kInAppBrowserAlignRight isEqualToString:_browserOptions.menu[kInAppBrowserPropAlign]]) {
    ...
    if (self.backButton && ![kInAppBrowserAlignRight isEqualToString:_browserOptions.backButton[kInAppBrowserPropAlign]]) {
        CGFloat width = [self getWidthFromButton:self.backButton];
        [leftButtons addObject:self.backButton];
        leftWidth += width;
    }
    
    if (self.forwardButton && [kInAppBrowserAlignRight isEqualToString:_browserOptions.forwardButton[kInAppBrowserPropAlign]]) {
    ...
    if (customButtons) {
        ...
        for (NSDictionary* customButton in [customButtons reverseObjectEnumerator]) {
            ...
            if (button) {
                ...
                if ([kInAppBrowserAlignRight isEqualToString:customButton[kInAppBrowserPropAlign]]) {
    ...
    if (_browserOptions.title) {
        ...
        self.titleLabel.textColor = [CDVInAppBrowserViewController colorFromRGBA:[self getStringFromDict:_browserOptions.title withKey:kInAppBrowserPropColor withDefault:@"#000000ff"]];
        
        if (_browserOptions.title[kInAppBrowserPropStaticText]) {
            self.titleLabel.text = _browserOptions.title[kInAppBrowserPropStaticText];
        }
        
        [self.toolbar addSubview:self.titleLabel];
    }
    
    self.view.backgroundColor = [CDVInAppBrowserViewController colorFromRGBA:[self getStringFromDict:_browserOptions.statusbar withKey:kInAppBrowserPropColor withDefault:@"#ffffffff"]];
...
- (UIButton*) createButton:(NSDictionary*) buttonProps action:(SEL)action withDescription:(NSString*)description
{
    ...
    if (buttonProps) {
        ...
        if (buttonProps[kInAppBrowserPropImage] || buttonProps[kInAppBrowserPropWwwImage]) {
            buttonImage = [self getImage:buttonProps[kInAppBrowserPropImage]
                                 altPath:buttonProps[kInAppBrowserPropWwwImage]
                              altDensity:[buttonProps[kInAppBrowserPropWwwImageDensity] doubleValue]];
            
            if (!buttonImage) {
                [self.navigationDelegate emitError:kInAppBrowserEmitCodeLoadFail
                                       withMessage:[NSString stringWithFormat:@"Image for %@, %@, failed to load.",
                                                    description,
                                                    buttonProps[kInAppBrowserPropImage]
                                                    ? buttonProps[kInAppBrowserPropImage] : buttonProps[kInAppBrowserPropWwwImage]]];
            }
        } else {
            [self.navigationDelegate emitWarning:kInAppBrowserEmitCodeUndefined
        ...
        if (buttonProps[kInAppBrowserPropImagePressed] || buttonProps[kInAppBrowserPropWwwImagePressed]) {
            buttonImagePressed = [self getImage:buttonProps[kInAppBrowserPropImagePressed]
                                        altPath:buttonProps[kInAppBrowserPropWwwImagePressed]
                                     altDensity:[buttonProps[kInAppBrowserPropWwwImageDensity] doubleValue]];;
            ...
            if (!buttonImagePressed) {
                [self.navigationDelegate emitError:kInAppBrowserEmitCodeLoadFail
                                       withMessage:[NSString stringWithFormat:@"Pressed image for %@, %@, failed to load.",
                                                    description,
                                                    buttonProps[kInAppBrowserPropImagePressed]
                                                    ? buttonProps[kInAppBrowserPropImagePressed] : buttonProps[kInAppBrowserPropWwwImagePressed]]];
            }
        } else {
            [self.navigationDelegate emitWarning:kInAppBrowserEmitCodeUndefined
    ...
    } else if (!buttonProps[kInAppBrowserPropImage]) {
    }
...
{
    // This method is not used by InAppBrowser. It is inherited from
...
- (void)showLocationBar:(BOOL)show
{
    ...
    CGFloat toolbarHeight = [self getFloatFromDict:_browserOptions.toolbar withKey:kInAppBrowserPropHeight withDefault:TOOLBAR_HEIGHT];
...
- (void)goMenu:(id)sender
{
    ...
    if (_browserOptions.menu && _browserOptions.menu[kInAppBrowserPropItems]) {
        NSArray* menuItems = _browserOptions.menu[kInAppBrowserPropItems];
        if (IsAtLeastiOSVersion(@"8.0")) {
            // iOS > 8 implementation using UIAlertController, which is the new way
            // to do this going forward.
            UIAlertController *alertController = [UIAlertController
                                                  alertControllerWithTitle:_browserOptions.menu[kInAppBrowserPropTitle]
                                                  message:nil
            ...
            if (_browserOptions.menu[kInAppBrowserPropCancel]) {
                UIAlertAction *cancelAction = [UIAlertAction
                                               actionWithTitle:_browserOptions.menu[kInAppBrowserPropCancel]
            ...
            UIActionSheet *popup = [[UIActionSheet alloc]
                                    initWithTitle:_browserOptions.menu[kInAppBrowserPropTitle]
            ...
            if (_browserOptions.menu[kInAppBrowserPropCancel]) {
                [popup addButtonWithTitle:_browserOptions.menu[kInAppBrowserPropCancel]];
...
- (void) rePositionViews {
    CGFloat toolbarHeight = [self getFloatFromDict:_browserOptions.toolbar withKey:kInAppBrowserPropHeight withDefault:TOOLBAR_DEF_HEIGHT];
    CGFloat webviewOffset = _browserOptions.fullscreen ? 0.0 : toolbarHeight;
    
    if ([_browserOptions.toolbarposition isEqualToString:kInAppBrowserToolbarBarPositionTop]) {
        [self.webView setFrame:CGRectMake(self.webView.frame.origin.x, [self getStatusBarOffset] + webviewOffset, self.webView.frame.size.width, self.webView.frame.size.height)];
...
{
    if (buttonProps) {
        NSString* event = buttonProps[kInAppBrowserPropEvent];
        if (event) {
...
- (void)webViewDidFinishLoad:(UIWebView*)theWebView
{
    ...
    if (self.titleLabel && _browserOptions.title
        && !_browserOptions.title[kInAppBrowserPropStaticText]
        && [self getBoolFromDict:_browserOptions.title withKey:kInAppBrowserPropShowPageTitle]) {
